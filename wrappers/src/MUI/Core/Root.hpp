...
namespace MUI
{
    ...
    class Root
    {
      ...
      public:
        ...
        const ::MUI_Command *GetValueAsCommandPtr(const unsigned long tagName) const;
        ...
        ::MUI_Palette_Entry *GetValueAsPaletteEntryPtr(const unsigned long tagName) const;
        ::MUI_PenSpec *GetValueAsPenSpecPtr(const unsigned long tagName) const;
        const ::MUI_PenSpec *GetValueAsConstPenSpecPtr(const unsigned long tagName) const;
        ::List *GetValueAsListPtr(const unsigned long tagName) const;
        const ::List *GetValueAsConstListPtr(const unsigned long tagName) const;
        ::MinList *GetValueAsMinListPtr(const unsigned long tagName) const;
        const ::MinList *GetValueAsConstMinListPtr(const unsigned long tagName) const;
