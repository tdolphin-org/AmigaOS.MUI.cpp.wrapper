...
namespace MUI
{
    ...
    bool Group::AddHead(const Object *pChildObject)
    {
        ...
        return (bool)DoMethod(muiObject(), MUIM_Group_AddHead, (IPTR)pChildObject);
    }
    ...
    bool Group::AddHead(const Root &child)
    {
        ...
        return (bool)DoMethod(muiObject(), MUIM_Group_AddHead, (IPTR)child.muiObject());
    }
#endif
    ...
    bool Group::AddTail(const Object *pChildObject)
    {
        ...
        return (bool)DoMethod(muiObject(), MUIM_Group_AddTail, (IPTR)pChildObject);
    }
    ...
    bool Group::AddTail(const Root &child)
    {
        ...
        return (bool)DoMethod(muiObject(), MUIM_Group_AddTail, (IPTR)child.muiObject());
    }
#endif
    ...
    bool Group::Remove(const Object *pChildObject)
    {
        ...
        return (bool)DoMethod(muiObject(), MUIM_Group_Remove, (IPTR)pChildObject);
    }
    ...
    bool Group::Remove(const Root &child)
    {
        ...
        return (bool)DoMethod(muiObject(), MUIM_Group_Remove, (IPTR)child.muiObject());
    }
#endif
    ...
    {
        if (pChildObject)
            DoMethod(muiObject(), OM_ADDMEMBER, (IPTR)pChildObject);
        return *this;
    }
    ...
    {
        if (pChildObject)
            DoMethod(muiObject(), OM_REMMEMBER, (IPTR)pChildObject);
        return *this;
    }
