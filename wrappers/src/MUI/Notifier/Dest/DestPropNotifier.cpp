...
namespace MUI
{
    ...
    DestPropNotifier::DestPropNotifier(const NotifierObject &notifierObject, const enum NotifyDestType notifyDestType)
      : DestGadgetNotifier(notifierObject, notifyDestType)
    {
    }
