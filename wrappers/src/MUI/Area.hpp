...
namespace MUI
{
    ...
    template <typename T, typename U> class AreaBuilderTemplate : public NotifyBuilderTemplate<T, U>
    {
      public:
        ...
        T &tagBackground(const long background);
    ...
    template <typename T, typename U> T &AreaBuilderTemplate<T, U>::tagBackground(const long background)
    {
        this->PushTag(MUIA_Background, background);
        return (T &)*this;
    }
