...
amigaos_m68k:
	...
	$(MAKE) -f makefile.generic.gcc.mk SUB_BUILD_PATH=amigaos/m68k CPPC=m68k-amigaos-g++ all

morphos_ppc:
	@echo "# Build for MorphOS PowerPC"
	$(MAKE) -f makefile.generic.gcc.mk SUB_BUILD_PATH=morphos/ppc CPPC=g++ all
